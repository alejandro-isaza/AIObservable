...
/**
 Create an invocation from a class and a selector. The selector property of the
...
/**
 Create an invocation from a protocol and a selector. The selector property of the
 invocation is initialized but you still need to set the target before invoking it.
