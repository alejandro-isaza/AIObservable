...
- (void)testTargetSelectorContstructor {
	NSInvocation_Constructors_TestClass* object = [[NSInvocation_Constructors_TestClass alloc] init];
...
- (void)testClassSelectorConstructor {
	...
	NSInvocation_Constructors_TestClass* impl = [[NSInvocation_Constructors_TestClass alloc] init];
	[inv setTarget:impl];
	[inv invoke];
...
- (void)testProtocolSelectorConstructorWithRequiredMethod {
	...
	NSInvocation_Constructors_TestProtocolImpl* impl = [[NSInvocation_Constructors_TestProtocolImpl alloc] init];
	[inv setTarget:impl];
	[inv invoke];
...
- (void)testProtocolSelectorConstructorWithOptionalMethod {
	...
	NSInvocation_Constructors_TestProtocolImpl* imp = [[NSInvocation_Constructors_TestProtocolImpl alloc] init];
	[inv setTarget:imp];
	[inv invoke];
